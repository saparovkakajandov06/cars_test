        ...
        <div class="col-xs-8 col-sm-8 col-md-6 col-xs-offset-2 col-sm-offset-2 col-md-offset-3 login-form" style="padding-top: 60px;">
            <div class="panel panel-default">
                <div class="panel-heading text-center">
                    <h2>Ларавел тест проект о Машины</h2>
                </div>
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            <label for="email" class="col-sm-4 col-md-4 control-label">Е-адрес</label>
                        ...
                        <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                            <label for="password" class="col-xs-3 col-sm-4 col-md-4 control-label">Пароль</label>
                        ...
                        <div class="form-group">
                            <div class="col-sm-6 col-md-6 col-sm-offset-4 col-md-offset-4">
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" name="remember" {{ old('remember') ? 'checked' : '' }}> Сохрани меня
                                    </label>
                                </div>
                            </div>
                        </div>
